...
- Treat 0 and 100 as distribution-relative extremes, not absolute market truths:
  - 100 means the current 24-hour signal is near the top of the available historical distribution across several greed/FOMO components.
  - 0 means the current 24-hour signal is near the bottom of the available historical distribution and/or dominated by risk/fear components.
- Current composite weights:
  - New weighted mentions percentile: 30%
  - FOMO score percentile: 25%
  - Sentiment percentile: 15%
  - Search trend momentum percentile: 10%
  - Risk score inverse percentile: 15%
