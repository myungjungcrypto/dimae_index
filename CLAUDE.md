...
- The headline gauge should be a semicircle, not a full circle. Place `Fear` on the lower side and `Greed` on the upper side so rising scores visually move upward toward greed.
